...
classDiagram
    ...
    Product --> Garantie : heeft
    Product --> Reparatie : heeft
    Product --> Verzekering : heeft
    Product --> Retourneren : kan worden geretourneerd

    Garantie --> Verlenging : optie op
...
### Sitemap
De sitemap laat zien hoe verschillende webpaginas met elkaar verbonden zijn. Dit kan je terug zien in onze versie van de Sitemap.
...
[Wireframes](NetWave%20wireframes.pdf)
[Wireframes](NetWave%20(3).pdf)

Door middel van de wireframes krijg je een goed overzicht over de webpagina's van de applicatie.
