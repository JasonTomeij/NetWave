...
De doestellingen van NetWave zijn vrij groot. Wij hebben korte termijn doelstellingen en ook voor het lange termijn. 
Voor het korte termijn wilt NetWave zo snel mogelijk de best mogelijk kwaliteit verkoppen. Dit gaan wij doen door veel geld te investeren in de research van kwaliteit. Zodat wij straks de beste kwaliteit hebben. Naast dat wij zo snel mogelijk de beste in de kwaliteit willen zijn. Is dat wij veel vestigingen gaan openen en zoveel mogelijk landen. Zodat NetWave internationaal groeit en we steeds bekender worden. het is daarom ook niet belangrijk voor NetWave om gelijk de beste te zijn.

Voor de lange termijn doelen hebben we een paar hele belangrijke de eerste is wel dat we natuurlijk binnen de top 3 telefoons zullen staan en met het oog voor de eerste plek natuurlijk. Dit kan ons aardig wat jaar duren omdat wij ons eerst echt focussen op het kleine zodat we daarna met winst die we draaien steeds meer kunnen riskeren. En daarmee proberen groot te worden. 

Ons tweede lange termijn doel is om de meeste omzet te krijgen binnen alle bedrijven. Wij willen het meeste verkopen en ook de meeste winst van iedereen te hebben. Hierdoor kunnen wij meer investeren en dus ook verder focussen op de andere doelen. 
Bij ons derde lange termijn doel is dat wij altijd genoeg mensen bij ons laten werken en dat we niet mensen moeten inhuren. Dit klinkt als een korte termijn doekl maar omdat we een foute keuzen hebben gemaakt loopt NetWave nu eigenlijk achter de feiten aan en moeten we dus veel mensen extern huren. Dit willen wij in de loop van jaren verbeteren en eigenlijk zelfs op 0 mensen extern houden. 
...
graph TD
    ...
    Projectteam --> Ontwikkelaars(Developing team in principe, die de app WAVE ontwikkelen.)
    Projectteam --> UXUI(UX/UI Designers, voor de opmaak en layout. )
    Projectteam --> Testers(testen of de applicatie naar behoren werkt.)
    Projectteam --> PO(Product Owner / Projectmanager)

    Projectteam --> Systemen
    Systemen --> ERP(ERP-systeem, dat gekoppeld is met Odoo)
    Systemen --> CRM(CRM-systeem, dat gekoppeld is met Odoo)
    Systemen --> BI(De BI-tool, zet alle data om in het geautomiseerde proces om in bruikbare data dat achter de schermen verwerkt kunnen worden. )
    ...
    Klanten --> Chatbot(zodat klanten sneller geholpen kunnen worden met simpele problemen. )
```
...
- Antwoordt op live chats van klanten in een kleine window rechts onderin of indien nodig een fullscreen. 
...
- Houdt de community netjes en helpt bij vragen, want dat helpt met klanten tevredenheid en loyaliteit. 
- Registreert automatisch het in het systeem, zodat het altijd in de event log teruggevonden kan worden op basis van een case id, tijdstip, actie etc. 
...
- **BI-systeem**: bekijkt wat klanten doen en wat beter kan.(geeft inzicht in de klantgegevens)
...
### 8. Extra rol: Loyalty manager (extra rol, voor het beloningsysteem die NetWave wilt toepassen in Wave)
...
![Product Vision Board](Documenten/Foto's/product-vision-board.png)


## Target group

Het doelgroep van ons bedrijf zijn jong volwassenen en volwassenen. Wij hebben hiervoor gekozen om een klant voor leven te hebben.
Wij hopen door ons te focussen op bedrijven de volwassenen aan te spreken. Zo willen wij ervoor zorgen dat we zowel bij bedrijven als volwassenen bekend zijn met ons merk.

## Needs

Met de sdg's die wij gekozen hebben willen wij een duurzaam merk zijn. Zo hebben wij bijvoorbeeld een verplichte duurzaamheidstrainingen. Ook werken we met fabrikanten die duurzaame materialen gebruiken. Ook prioriteren wij kwalliteit in ons product. Daar hebben wij voor gekozen omdat wij klanten tevreden willen houden over ons product. Daarmee houden we trouwe klanten.

## Product

In ons bedrijf verkopen wij telefoons en oortjes.
Zoals eerder vermeld zijn wij dus gefocust op de kwaliteit van onze product en zitten wij op 5 sterren kwaliteit. 

## Business goals

Ook onze business goals zijn dus gericht op duurzaamheid en kwaliteit.
De productie van ons telefoon is dus gericht op de duurzaamheid door de materiaal die we gebruiken. Doordat we dus focussen op kwaliteit willen wij er voor zorgen dat ons product meer bekend staat om de kwaliteit dan het merk zelf.

## Competitors

Onze concurenten zijn dus andere telefoonedrijven zoals Telenova. Zo heb je er meerdere. 

Het voordeel van onze concurenten is dat hun meer omzet draaien aangezien de meeste zijn gefocust op de prijs. Daar hebben ze een voorsprong op. 

Het voordeel dat wij hebben is dat meerdere bedrijven zijn gefocust op de prijs en niet op de kwaliteit. Wij zijn dus een van de weinige die in deze markt zitten. 


## Revenue streams

Door de juiste doelgroep te kiezen en te benaderen willen wij vaste klanten hebben. Dit zorgt er voor dat we een standaard inkomen hebben. Klanttevredenheid speelt ook een belangrijke rol hierin. Door het tevreden houden van onze klanten kunnen we er voor zorgen dat onze klanten dus terugkomen bij ons.

## Cost factors

Marketing is een van onze basiskosten. Wij willen ervoor zorgen dat ons product bekend staat om de kwaliteit. Om dat te bereiken moeten we reclame maken voor ons product.

Het inkopen van materialen voor onze telefoons is ook onderdeel van de basiskosten.

## Channels

Wij zijn als Netwave bevestigd in meerdere landen en willen dit uitbreiden naar meerdere. Zo kunnen we ook ons product bekender maken. 

Ook hebben we een online webshop waar de telefoons verkocht worden.
...
[Download de nieuwe Sitemap planning PDF](./Sitemap%20planning.pdf)


[Download de Wireframes](./NetWave.pdf)
## Wireframes

[wireframe1](figma1.png)
[wireframe2](figma2.png)
[wireframe3](figma3.png)
[wireframe4](figma4.png)
[wireframe5](figma6.png)
[wireframe6](figma7.png)
[wireframe7](figma8.png)
[wireframe8](figma9.png)
[wireframe9](figma10.png)
[wireframe10](figma11.png)
[wireframe11](figma12.png)
[wireframe12](figma13.png)
